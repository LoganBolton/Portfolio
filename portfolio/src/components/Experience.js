    ...
    return (
        <div className="experience-container">
            ...
            <div className = "cardsDiv flex justify-evenly">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden my-10">
                    <div className="p-8">
                        ...
                        <p className="mt-2 text-gray-500">Built a AI model to analyze and determine customer sentiment of IMDB reviews</p>
                    </div>
                </div>
